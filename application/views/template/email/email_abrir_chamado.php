...
<div class="col-sm-6">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><b><?= "Novo Chamado ".$data3['id_chamado']?></b></h3>
    </div>
    <div class="panel-body">
        
        <div class="row">

        <p><?php echo "Prezado ".$data3['nome'] ?> </p>
        <p><?php echo "O chamado <strong>".$data3['id_chamado']."</strong> foi inserido em ". date("d/m/Y h:i:s"); ?></p>

...
function chatHeartbeat(){
	...
	jQuery.ajax({
	  url: "http://localhost/helpdesk/chat/teste/chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	jQuery.post("http://localhost/helpdesk/chat/teste/closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
			jQuery.post("http://localhost/helpdesk/chat/teste/sendchat", {to: chatboxtitle, message: message} , function(data){
...
function startChatSession(){  
	jQuery.ajax({
	  url: "http://localhost/helpdesk/chat/teste/startchatsession",
	  //url: $('#base_url').val() + "chat/startchatsession",
	  cache: false,
	  dataType: "json",
	  success: function(data) {
